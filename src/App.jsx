...
function App() {
  ...
  const parcours = [
    {
      period: '2024-2025',
      title: 'Alternant Développeur C#',
      location: 'Aurera',
      type: 'professional',
      description: "Développement d'applications en C# .NET",
    },
    {
      period: '2023-2024',
  ...
  const socialLinks = {
    github: 'https://github.com/MatheoKatbie',
    cv: '/cv.pdf',
  }
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-white">
      ...
      <motion.nav
        ...
        className="fixed top-0 w-full z-50 bg-[#0F172A]/80 backdrop-blur-md border-b border-white/10"
      >
        ...
        >
          <div className="text-left">
            ...
            <p className="text-lg text-gray-300 leading-relaxed mb-6">
              Passionné par le développement et les nouvelles technologies, je suis actuellement en alternance chez
              Aurera où je développe des solutions innovantes en C# .NET. Mon parcours m'a permis d'acquérir une solide
              expérience en développement web et logiciel.
            </p>
      ...
      <section id="technologies" className="py-20 px-4 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-[#0F172A] via-[#131c2f] to-[#0F172A]" />
        <div className="max-w-6xl mx-auto relative">
          <h2 className="text-4xl font-bold text-center mb-16 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500">
            Technologies
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              className="p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10"
            >
              <h3 className="text-xl font-bold mb-6 text-gray-300">Frontend</h3>
              <div className="grid grid-cols-4 gap-6">
            ...
            <motion.div
              ...
              className="p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10"
            >
              <h3 className="text-xl font-bold mb-6 text-gray-300">Backend</h3>
              <div className="grid grid-cols-4 gap-6">
            ...
            <motion.div
              ...
              className="p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10"
            >
              <h3 className="text-xl font-bold mb-6 text-gray-300">Outils</h3>
              <div className="grid grid-cols-4 gap-6">
      ...
      <section id="competences" className="py-20 px-4 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-[#0F172A] via-[#131c2f] to-[#0F172A]" />
        <h2 className="text-4xl font-bold text-center mb-12 relative bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-500">
          Compétences
        </h2>
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 relative">
          {competences.map((competence, index) => (
            <motion.div
              ...
              className="p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 flex flex-col items-center text-center cursor-pointer h-auto hover:bg-white/10 transition-colors"
            >
              <div className="flex items-center gap-4 mb-3 w-full">
                <motion.div whileHover={{ rotate: 360 }} transition={{ duration: 0.5 }} className="text-blue-400">
                  {competence.icon}
                </motion.div>
              ...
              <div className="flex flex-wrap gap-2 justify-start w-full mb-4">
                {competence.badges.map((badge, badgeIndex) => (
                  <motion.span
                    ...
                    className="px-3 py-1 text-sm font-medium rounded-full bg-white/5 text-blue-300 border border-blue-500/20"
                  >
                    {badge}
                  </motion.span>
                ))}
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 gap-8 relative">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="relative group cursor-pointer bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden"
            >
              <div className="flex flex-col md:flex-row">
                ...
                <div className="p-6 md:w-2/3 flex flex-col justify-between">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.technologies.map((tech, techIndex) => (
                          <span
                            key={techIndex}
                            className="px-3 py-1 text-sm font-medium rounded-full bg-blue-500/10 text-blue-300 border border-blue-500/20"
                          >
                            {tech}
                          </span>
                        ))}
                  ...
                  <button
                    ...
                    className="mt-4 px-4 py-2 text-sm font-medium text-blue-400 hover:text-blue-300 transition-colors flex items-center gap-2 self-end"
                  >
                    Voir plus
        ...
        {selectedProject && (
          ...
          >
            <motion.div
              ...
              className="bg-[#1a2234] rounded-2xl p-6 max-w-2xl w-full relative overflow-hidden"
            >
              <button
                onClick={() => setSelectedProject(null)}
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedProject.technologies.map((tech, index) => (
                    <span
                      key={index}
                      className="px-3 py-1 text-sm font-medium rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20"
                    >
                      {tech}
                    </span>
                  ))}
      ...
      <section id="parcours" className="py-20 px-4 relative">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-0 md:left-1/2 transform md:-translate-x-px h-full w-0.5 bg-gradient-to-b from-blue-500 via-purple-500 to-pink-500" />
              ...
              >
                ...
                <div className={`w-full md:w-5/12 ${index % 2 === 0 ? 'md:text-right' : ''}`}>
                  ...
                  >
                    ...
                    <p className="text-purple-400 font-medium mb-2">{item.location}</p>
                    <p className="text-gray-400 text-sm">{item.description}</p>
                  </motion.div>
                </div>

                {/* Timeline dot */}
                <div className="absolute left-0 md:left-1/2 transform -translate-x-1/2 w-4 h-4 rounded-full bg-blue-500 border-4 border-[#0F172A]" />
              </motion.div>
            ))}
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none text-white"
                />
              </div>
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg font-bold hover:opacity-90 transition-opacity"
              >
                Envoyer
              </motion.button>
            </form>
